...
if __name__ == '__main__':
    ...
    # split configurations for which the model has been trained and tested
    # addprim_jump 
    # addprim_turn_left 
    # simple
    # filler_num1
    parser.add_argument('--data_split', type=str, default= 'filler_num1',
                        help="data split of SCAN dataset", required=False)
    # layers, heads embeddings and epochs are altered for hyperparameter tunuing 
    parser.add_argument('--n_layer', type=int, default=4, #2,
                        help="number of layers", required=False)
    parser.add_argument('--n_head', type=int, default= 4, #2,
                        help="number of heads", required=False)
    parser.add_argument('--n_embd', type=int, default= 32, #16,
